...
namespace LibraryItems
{
    public abstract class LibraryItem : IComparable<LibraryItem>
    {
        ...
        //Precondition: an item has been passed to the method
        //Postcondition: 
        public int CompareTo(LibraryItem Item) 
        {
            int TitleCompare = 0; //comparison between subsequent titles
            ...
            if (this != null && Item != null) // both not null?
                TitleCompare = string.Compare(this.Title, Item.Title); // Title difference?
